...
- [x] 1. Fix tasks screen sidebar issue
...
- [x] 2. Fix shell navigation stability
...
- [x] 3. Fix calendar edit value loading and quality layer logic
  - [x] 3.1 Modify `LogHabitEventDialog` to load existing event data for the selected date
  ...
  - [x] 3.2 Verify and document quality layer as binary attribute
...
- [x] 4. Fix habit card value display
...
- [x] 5. Fix habit card streak and percentage accuracy
  - [x] 5.1 Calculate accurate streak numbers
  ...
  - [x] 5.2 Calculate accurate completion percentage
...
- [x] 6. Integrate quality layer details in habit detail screen
...
- [x] 7. Implement habit card quick action buttons
  - [x] 7.1 Create `HabitQuickActionButton` widget
  ...
  - [x] 7.2 Add special handling for minimum goal habits with quality layer
  ...
  - [x] 7.3 Integrate quick action buttons into `HabitCard`
...
- [x] 8. Implement unified home screen
  ...
  - [x] 8.3 Create `DailyProgressHeader` widget
  ...
  - [x] 8.4 Create `DailyItemCard` widget
  ...
  - [x] 8.5 Implement new home screen layout
