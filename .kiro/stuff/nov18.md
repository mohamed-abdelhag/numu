...
3. the edit value for habit in the cakender should load with the current value not 0 
and also the qulty is yes no , so like if i have 20 reps with qulty layer labled focused so i click the value 20 and ticke focused thats it means done 20 reps and was focsue not 20 focused reps and not counting towards 20 reps its the same reps am not really sure if the system currenyy dopes that dont change without checking cuurent imepplementation

4. create the home screen to show all habvtis and tasks due today in a sinle list dorted byt time under welcme user name and also saying x tkas and habits with a prgress bar at the top of the list and soem messges like lets get strated almsot there foign well and done for the day depeing on precentage completed

5. the app somtimes laods outside shell causing unsbality make sure this never happens and closing starting he app alwyas sttarts inside the shell
